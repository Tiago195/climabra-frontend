  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {/* Agenda de hoje (timeline por turno) — coluna principal */}
        ...
        {/* Coluna lateral: visitas na semana + clientes recentes */}
        <div className="space-y-6">
          {loading ? <Skeleton className="h-48" /> : <WeekVisitsChart appointments={appointments} />}
